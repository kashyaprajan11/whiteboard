import { ElementType, PointsType, Tools } from "@/types";
...
const onLine = (
  ...
  const a: PointsType = { x: x1, y: y1 };
  const b: PointsType = { x: x2, y: y2 };
  const c: PointsType = { x, y };
...
const distance = (a: PointsType, b: PointsType) =>
